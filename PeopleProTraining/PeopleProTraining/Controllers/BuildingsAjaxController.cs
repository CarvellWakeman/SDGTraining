...
{
    public class BuildingsAjaxController : Controller
    {
        ...
        // GET: BuildingsAjax/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: BuildingsAjax/Create
